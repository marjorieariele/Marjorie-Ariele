...
input_sample = pd.DataFrame({"TIPO_DIA": pd.Series(["example_value"], dtype="object"), "DIA_SEMANA": pd.Series(["example_value"], dtype="object"), "FUNCAO": pd.Series(["example_value"], dtype="object")})
