...
workspace_name = "wps-ml-experiments" # PLACEHOLDER
subscription_id = "c9cb1345-28bd-4f25-a07c-5f7a611e797f" # PLACEHOLDER
resource_group = "rg-ml-experiments" # PLACEHOLDER
experiment_name = "anomalia_cluster" # PLACEHOLDER
iteration = "1"  # PLACEHOLDER
run_id = "AutoML_88b097ee-9306-478a-ad05-98e07db4026e_1"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'enable_early_stopping':True,'enable_ensembling':True,'enable_stack_ensembling':True,'ensemble_iterations':15,'enable_onnx_compatible_models':False,'max_cores_per_iteration':-1,'send_telemetry':True,'blacklist_algos':['TensorFlowLinearClassifier','TensorFlowDNN'],'whitelist_models':None,'compute_target':'bibi','enable_dnn':False,'enable_code_generation':True,'experiment_exit_score':None,'experiment_timeout_minutes':60,'featurization':{'_blocked_transformers':[],'_column_purposes':{'DIA_SEMANA':'Categorical','FUNCAO':'Categorical'},'_transformer_params':{'Imputer':[]},'_drop_columns':['TIPO_DIA']},'hyperdrive_config':None,'grain_column_names':None,'is_timeseries':False,'iteration_timeout_minutes':60,'max_concurrent_iterations':1,'metric_operation':'maximize','model_explainability':True,'n_cross_validations':None,'name':'anomalia_cluster','path':'./sample_projects/anomalia_cluster','primary_metric':'AUC_weighted','region':'brazilsouth','resource_group':'rg-ml-experiments','subscription_id':'c9cb1345-28bd-4f25-a07c-5f7a611e797f','task_type':'classification','validation_size':None,'test_size':None,'vm_type':'STANDARD_DS3_V2','workspace_name':'wps-ml-experiments','label_column_name':'CLASSIFICACAO_ANOMALIA','positive_label':None,'save_mlflow':True,'enable_batch_run':True,'dataset_id':'5e8d188b-e41f-493e-a56a-cd6044cd5175'} # PLACEHOLDER
pipeline_spec = "{\"objects\":[{\"spec_class\":\"preproc\",\"class_name\":\"MaxAbsScaler\",\"module\":\"sklearn.preprocessing\",\"param_args\":[],\"param_kwargs\":{},\"prepared_kwargs\":{}},{\"spec_class\":\"sklearn\",\"class_name\":\"XGBoostClassifier\",\"module\":\"automl.client.core.common.model_wrappers\",\"param_args\":[],\"param_kwargs\":{\"tree_method\":\"auto\"},\"prepared_kwargs\":{}}],\"pipeline_id\":\"c7af0367625be6ac5c2fecbfc72ed444cb7a2111\",\"module\":\"sklearn.pipeline\",\"class_name\":\"Pipeline\"}" # PLACEHOLDER
pipeline_id = "c7af0367625be6ac5c2fecbfc72ed444cb7a2111" # PLACEHOLDER
dataprep_json = "{\"datasets\":0,\"training_data\":{\"datasetId\":\"5e8d188b-e41f-493e-a56a-cd6044cd5175\"}}" # PLACEHOLDER
